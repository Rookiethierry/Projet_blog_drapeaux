...
const Countries = () => {
  ...
  //   récupere nos données_____________________________
  useEffect(
    () => {
      if (playOnce) {
        axios
      ...
      //   trie de nos country_____________________________
      const sortedCountry = () => {
  ...
  //rendu __________________________________________________________
  return (
